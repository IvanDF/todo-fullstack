...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // import axios
...
new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
  ...
  methods: {
    // ajax call function
    apiCall: function apiCall(url, type, array) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url + type).then(function (resp) {
    ...
    countTodos: function countTodos(id) {
      var _this = this;

      this.allTodos.forEach(function (todo) {
        if (id === todo.todo_list_id) {
          var num = _this.allTodos.length;
        }

        return num;
      });
    },
    setImportance: function setImportance() {
    ...
    cathegoryListFunc: function cathegoryListFunc(condition) {
    ...
    showPriorityTodos: function showPriorityTodos() {
      var _this2 = this;

      this.singleTodoList = [];
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(this.baseUrl + "todos").then(function (resp) {
        resp.data.forEach(function (el) {
          if (el.priority == 1) {
            _this2.singleTodoList.push(el);
          }
        });
      });
    },
    setTodoListIndex: function setTodoListIndex(todoList, id) {
      var _this3 = this;
      ...
      this.allTodos.forEach(function (todo) {
        if (id === todo.todo_list_id) {
          if (!_this3.singleTodoList.includes(todo)) {
            _this3.singleTodoList.push(todo);
          }
        }
      });
      this.createTodo.todo_list_id = id;
    },
    todoCounter: function todoCounter(id) {
      var counter = 0;
      this.allTodos.forEach(function (todo) {
    ...
    createTodoItem: function createTodoItem() {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://127.0.0.1:8000/api/todos', this.createTodo);
      this.createTodo.todo_list_id = this.listIndex;
      this.createTodo.importance = '!';
      this.createTodo.priority = 0;
      this.createTodo.content = '';
      this.createTodo.deadline = '', this.createTodo.completed = 0, window.location.reload(true);
    },
    deleteTodoItem: function deleteTodoItem(id) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('http://127.0.0.1:8000/api/todos/' + id);
      window.location.reload(true);
    },
    createTodoList: function createTodoList() {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://127.0.0.1:8000/api/todoLists', this.createList);
      window.location.reload(true);
    },
    deleteTodoList: function deleteTodoList(id) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('http://127.0.0.1:8000/api/todoLists/' + id);
      window.location.reload(true);
    },
    updateTodo: function updateTodo(todoItem, id) {
      this.modifyTodo = false;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put('http://127.0.0.1:8000/api/todos/' + id, todoItem);
      window.location.reload(true);
    },
    updateTodoList: function updateTodoList(todoList, id) {
      this.modifyTodoList = false;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put('http://127.0.0.1:8000/api/todoLists/' + id, todoList);
      window.location.reload(true);
    },
    importanceValues: function importanceValues(el) {
      if (el.length > 1) {
        if (el == '!!') {
          return 'alert';
        } else {
    ...
    managelist: function managelist() {
      this.deleteList = !this.deleteList;
      this.modifyTodoList = !this.modifyTodoList;
    },
    todoDone: function todoDone(todoItem, id) {
      todoItem.completed === 0 ? todoItem.completed = 1 : todoItem.completed = 0;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put('http://127.0.0.1:8000/api/todos/' + id, todoItem);
      window.location.reload(true);
    }
  }
...
__webpack_require__(/*! /Users/ivandf/Desktop/todo-fullstack/back-end/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/ivandf/Desktop/todo-fullstack/back-end/resources/sass/app.scss */"./resources/sass/app.scss");
